...
const columnData = [
  { id: 'name', numeric: false, disablePadding: false, label: 'Champion' },
  ...
  { id: 'cs', numeric: true, disablePadding: false, label: 'CS' },
];
  ...
  return (
    ...
    >
      <div className={classes.title}>
        <Typography variant="title">Champion Stats</Typography>
      </div>
                ...
                {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell numeric>{n.cs}</TableCell>
                    </TableRow>
                  );
                })}
                {emptyRows > 0 && (
